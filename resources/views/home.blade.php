                ...
                <div class="tt-header-col">
                    ...
                    <div class="tt-logo">
                        <a href="/">
                            ...
                            <img src="{{ asset('img/logo-light.png') }}" class="tt-logo-light magnetic-item" alt="Logo">
                            <!-- logo light -->
           ...
           -->
             ...
             <div class="ph-appear">Subtitle</div>
                        ...
                        <h1 class="ph-caption-title text-center">
                            <div class="ph-appear"><em class="text-stroke-light">Limit</em> Foundation<br>
                                                    ...
                                                    <div class="pgi-image-holder">
                                                        <div class="pgi-image-inner anim-zoomin">
                                                            <figure class="pgi-image ttgr-height">
                                                                <img src="{{ asset('img/nft/Characters....jpg') }}"
                                                                    alt="image">
                                                            </figure> <!-- /.pgi-image -->
                                                        </div> <!-- /.pgi-image-inner -->
                                            ...
                                            <div class="portfolio-grid-item">
                                                <a href="single-project-2.html" class="pgi-image-wrap"
                                                    ...
                                                    <div class="pgi-image-holder">
                                                        <div class="pgi-image-inner anim-zoomin">
                                                            <figure class="pgi-image ttgr-height">
                                                                <img src="{{ asset('img/nft/Other Planets.jpg') }}"
                                                                    alt="image">
                                                            </figure> <!-- /.pgi-image -->
                                                        </div> <!-- /.pgi-image-inner -->
                                                    </div> <!-- /.pgi-image-holder -->
              ...
              -->
                                <div class="tt-accordion tt-ac-borders">
                                    <div class="tt-accordion-item anim-fadeinup">
                                        ...
                                        <div class="tt-accordion-content max-width-800">
                                            <p>Advantage old had otherwise sincerity dependent additions. It in adapted
                                                natural hastily is justice. Six draw you him <a href="">newspaper
                                                    assurance</a>. Prepare garrets it expense windows shewing do an. She
                                                projection advantages resolution son indulgence. Part sure on no long life
                                                am at ever. In songs above he as drawn.</p>
                                    ...
                                    <div class="tt-accordion-item anim-fadeinup">
                                        ...
                                        <div class="tt-accordion-content max-width-800">
                                            <p>Allow miles wound place the leave had. To sitting subject no improve studied
                                                limited. Ye indulgence unreserved connection alteration appearance my an
                                                astonished. Up as seen sent make he they of. Her raising and himself pasture
                                                believe females. Fancy she stuff after aware merit small his.</p>
                                        </div> <!-- /.tt-accordion-content -->
                                    </div> <!-- /.tt-accordion-item -->
                                    ...
                                    <div class="tt-accordion-item anim-fadeinup">
                                        ...
                                        <div class="tt-accordion-content max-width-800">
                                            <p>Rank tall boy man them over post now. Off into she bed long fat room.
                                                ...
                                                Not may too nay busy last song must sell. An newspaper assurance discourse
                                                ye certainly. Soon gone game and why many calm have.</p>
                                        </div> <!-- /.tt-accordion-content -->
                                    </div> <!-- /.tt-accordion-item -->
                                    ...
                                    <div class="tt-accordion-item anim-fadeinup">
                                        ...
                                        <div class="tt-accordion-content max-width-800">
                                            <p>To sure calm much most long me mean. Able rent long in do we. Uncommonly no
                                                it announcing melancholy an in. Mirth learn it he given. Secure shy favour
                                                length all twenty denote. He felicity no an at packages answered opinions
                                                juvenile.</p>
                                        </div> <!-- /.tt-accordion-content -->
                                    </div> <!-- /.tt-accordion-item -->
                        ...
                        <ul class="tt-logo-wall anim-fadeinup">
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-1-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-1-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-2-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-2-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-3-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-3-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-4-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-4-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-5-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-5-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-6-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-6-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-7-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-7-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-8-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-8-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-9-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-9-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                            <li>
                                <a href="https://themetorium.net/" class="cursor-alter" target="_blank" rel="noopener">
                                    <img src="{{ asset('img/clients/client-10-light.png') }}" class="lv-client-light"
                                        alt="Client">
                                    <img src="{{ asset('img/clients/client-10-dark.png') }}" class="lv-client-dark"
                                        alt="Client">
                                </a>
                            </li>
                                            ...
                                            <a href="blog-post.html" class="tt-bci-image-wrap"
                                                ...
                                                <figure class="tt-bci-image">
                                                    <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}"
                                                        data-src="{{ asset('img/blog/carousel/blog-carousel-1.jpg') }}"
                                                        alt="Image">
                                                </figure> <!-- /.tt-bci-image -->
                                            </a> <!-- /.tt-bci-image-wrap -->
                ...
                ============================== -->
                                        <div class="tt-blog-carousel-item">
                                            <a href="blog-post.html" class="tt-bci-image-wrap"
                                                ...
                                                <figure class="tt-bci-image">
                                                    <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}"
                                                        data-src="{{ asset('img/blog/carousel/blog-carousel-2.jpg') }}"
                                                        alt="Image">
                                                </figure> <!-- /.tt-bci-image -->
                                            </a> <!-- /.tt-bci-image-wrap -->
                ...
                ============================== -->
                                        <div class="tt-blog-carousel-item">
                                            <a href="blog-post.html" class="tt-bci-image-wrap"
                                                ...
                                                <figure class="tt-bci-image">
                                                    <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}"
                                                        data-src="{{ asset('img/blog/carousel/blog-carousel-3.jpg') }}"
                                                        alt="Image">
                                                </figure> <!-- /.tt-bci-image -->
                                            </a> <!-- /.tt-bci-image-wrap -->
                ...
                ============================== -->
                                        <div class="tt-blog-carousel-item">
                                            <a href="blog-post.html" class="tt-bci-image-wrap"
                                                ...
                                                <figure class="tt-bci-image">
                                                    <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}"
                                                        data-src="{{ asset('img/blog/carousel/blog-carousel-4.jpg') }}"
                                                        alt="Image">
                                                </figure> <!-- /.tt-bci-image -->
                                            </a> <!-- /.tt-bci-image-wrap -->
                ...
                ============================== -->
                                        <div class="tt-blog-carousel-item">
                                            <a href="blog-post.html" class="tt-bci-image-wrap"
                                                ...
                                                <figure class="tt-bci-image">
                                                    <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}"
                                                        data-src="{{ asset('img/blog/carousel/blog-carousel-5.jpg') }}"
                                                        alt="Image">
                                                </figure> <!-- /.tt-bci-image -->
                                            </a> <!-- /.tt-bci-image-wrap -->
                    ...
                    <div class="footer-col tt-align-center order-m-last">
                        <div class="footer-col-inner">
                            ...
                            <div class="tt-copyright text-gray">
                                <a href="https://themetorium.net" target="_blank" rel="noopener"

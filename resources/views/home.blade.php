            ...
            <div class="tt-header-col">
                ...
                <div class="tt-logo">
                    <a href="index.html">
                        ...
                        <img src="{{ asset('img/logo-light.png') }}" class="tt-logo-light magnetic-item" alt="Logo"> <!-- logo light -->
                        <img src="{{ asset('img/logo-dark.png') }}" class="tt-logo-dark magnetic-item" alt="Logo"> <!-- logo dark -->
                    </a>
                </div>
                <!-- End logo -->
                                                ...
                                                <div class="pgi-image-holder">
                                                    <div class="pgi-image-inner anim-zoomin">
                                                        <figure class="pgi-image ttgr-height">
                                                            <img src="{{ asset('img/portfolio/1200/portfolio-1.jpg') }}" alt="image">
                                                        </figure> <!-- /.pgi-image -->
                                                    </div> <!-- /.pgi-image-inner -->
                                        ...
                                        <div class="portfolio-grid-item">
                                            <a href="single-project-2.html" class="pgi-image-wrap" data-cursor="View<br>Project">
                                                ...
                                                <div class="pgi-image-holder">
                                                    <div class="pgi-image-inner anim-zoomin">
                                                        <figure class="pgi-image ttgr-height">
                                                            <img src="{{ asset('img/portfolio/1200/portfolio-2.jpg') }}" alt="image">
                                                        </figure> <!-- /.pgi-image -->
                                                    </div> <!-- /.pgi-image-inner -->
                                                </div> <!-- /.pgi-image-holder -->
                                            </a> <!-- /.pgi-image-wrap -->
                                                ...
                                                <div class="pgi-image-holder">
                                                    <div class="pgi-image-inner anim-zoomin">
                                                        <figure class="pgi-video-wrap ttgr-height">
                                                            <video class="pgi-video" loop muted preload="metadata" poster="{{ asset('vids/fashion-shoot.jpg') }}">
                                                                <source src="{{ asset('vids/fashion-shoot.mp4') }}" type="video/mp4">
                                                                <source src="{{ asset('vids/fashion-shoot.webm') }}" type="video/webm">
                                                            </video>
                                        ...
                                        <div class="portfolio-grid-item">
                                            <a href="single-project-4.html" class="pgi-image-wrap" data-cursor="View<br>Project">
                                                ...
                                                <div class="pgi-image-holder">
                                                    <div class="pgi-image-inner anim-zoomin">
                                                        <figure class="pgi-image ttgr-height">
                                                            <img src="{{ asset('img/portfolio/1200/portfolio-3.jpg') }}" alt="image">
                                                        </figure> <!-- /.pgi-image -->
                                                    </div> <!-- /.pgi-image-inner -->
                                                </div> <!-- /.pgi-image-holder -->
                                            </a> <!-- /.pgi-image-wrap -->
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="tt-blog-carousel-item">
                                        <a href="blog-post.html" class="tt-bci-image-wrap" data-cursor="Read<br>More">
                                            <figure class="tt-bci-image">
                                                <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}" data-src="{{ asset('img/blog/carousel/blog-carousel-1.jpg') }}" alt="Image">
                                            </figure> <!-- /.tt-bci-image -->
                                        </a> <!-- /.tt-bci-image-wrap -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="tt-blog-carousel-item">
                                        <a href="blog-post.html" class="tt-bci-image-wrap" data-cursor="Read<br>More">
                                            <figure class="tt-bci-image">
                                                <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}" data-src="{{ asset('img/blog/carousel/blog-carousel-2.jpg') }}" alt="Image">
                                            </figure> <!-- /.tt-bci-image -->
                                        </a> <!-- /.tt-bci-image-wrap -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="tt-blog-carousel-item">
                                        <a href="blog-post.html" class="tt-bci-image-wrap" data-cursor="Read<br>More">
                                            <figure class="tt-bci-image">
                                                <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}" data-src="{{ asset('img/blog/carousel/blog-carousel-3.jpg') }}" alt="Image">
                                            </figure> <!-- /.tt-bci-image -->
                                        </a> <!-- /.tt-bci-image-wrap -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="tt-blog-carousel-item">
                                        <a href="blog-post.html" class="tt-bci-image-wrap" data-cursor="Read<br>More">
                                            <figure class="tt-bci-image">
                                                <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}" data-src="{{ asset('img/blog/carousel/blog-carousel-4.jpg') }}" alt="Image">
                                            </figure> <!-- /.tt-bci-image -->
                                        </a> <!-- /.tt-bci-image-wrap -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="tt-blog-carousel-item">
                                        <a href="blog-post.html" class="tt-bci-image-wrap" data-cursor="Read<br>More">
                                            <figure class="tt-bci-image">
                                                <img class="swiper-lazy" src="{{ asset('img/low-qlt-thumb.jpg') }}" data-src="{{ asset('img/blog/carousel/blog-carousel-5.jpg') }}" alt="Image">
                                            </figure> <!-- /.tt-bci-image -->
                                        </a> <!-- /.tt-bci-image-wrap -->
                ...
                <div class="footer-col tt-align-center order-m-last">
                    <div class="footer-col-inner">
                        ...
                        <div class="tt-copyright text-gray">
                            ...
                            </a> <a href="https://market.mrcode.ir" target="_blank" style="color:#0a0a0a">دانلود قالب سایت</a>
                        </div>
